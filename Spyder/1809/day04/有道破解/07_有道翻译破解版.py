...
bv_md5 = hashlib.md5()
bv_md5.update('5.0 (Macintosh; Intel Mac OS X 10_14_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36'.encode('utf-8'))
bv = bv_md5.hexdigest()
...
# loads()可把json格式的字符串转为Python的数据类型
