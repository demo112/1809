...
class TopicBlogtype(models.Model):

    class Meta:
        managed = False
        db_table = 'topic_blogtype'
...
class UsersReply(models.Model):
    content = models.TextField()
    reply_time = models.DateTimeField()

    class Meta:
        managed = False
        db_table = 'users_reply'
